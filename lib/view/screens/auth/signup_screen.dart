      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child : Column(
            ...
            children: [
              GlithEffect(child: const Text("Welcome To TikTok ICT" ,style: TextStyle(fontWeight: FontWeight.w900 , fontSize: 30),)),
              SizedBox(height: 25,),
              InkWell(
               onTap: () {
              ...
              Container(
                ...
                child: TextInputField(
                  ...
                  myLabelText: 'Confirm_Password'.tr,
                  myIcon: Icons.lock,
                  toHide: true,
                ),
              ),
             ...
             AuthController.instance.SignUp(_usernameController.text, _emailController.text,_setpasswordController.text, AuthController.instance.proimg);
                  ...
                  child: Text('tSignup'.tr))),
                    TextButton(onPressed: (){

              Navigator.push(context, MaterialPageRoute(builder: (context)=>LoginScreen()));
            }, child: Text('not_user'.tr))
